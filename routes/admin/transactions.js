...
router.get('/transactions/view/:id', ensureAuthenticated, checkAccessMiddleware(6),transactionsController.getRiderTransactions.bind(transactionsController));
router.delete('/earnings/delete/:id', ensureAuthenticated,checkAccessMiddleware(7), earnings_Controller.deleteEarning.bind(earnings_Controller));
