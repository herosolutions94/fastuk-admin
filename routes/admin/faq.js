...
router.get('/faqs/add', ensureAuthenticated, faqController.renderAddFaqPage.bind(faqController));

router.post('/add-faqs', ensureAuthenticated, upload, faqController.addFaq.bind(faqController));
router.get('/faqs', ensureAuthenticated, faqController.getFaqs.bind(faqController));
