...
class PageModel extends BaseModel {
    ...
    async insertParcels(parcels) {
        ...
        for (const parcel of parcels) {
            const values = [parcel.request_id, parcel.length, parcel.width, parcel.height, parcel.weight, 
                parcel.quantity, parcel.destination, parcel.source, parcel.parcelNumber, parcel.distance, 
                parcel.parcelType, parcel.postcode, parcel.parcel_round_trip];
