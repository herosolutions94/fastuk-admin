      ...
      cleanedData.password = await bcrypt.hash(cleanedData.password, 10);
        ...
        async editSubAdmin(req, res) {
            try {
                ...
                const subAdmin = (await SubAdmin.getSubAdminById(subAdminId, 'sub_admin'))[0]; // Extract the first rider if it's returned as an array
        ...
        async updateSubAdmin(req, res) {
            try {
                ...
                const currentSubAdmin = (await SubAdmin.getSubAdminById(subAdminId,'sub_admin'))[0];
        ...
        async deleteSubAdmin(req, res) {
            ...
            try {
                ...
                const currentSubAdmin = (await SubAdmin.getSubAdminById(subAdminId,'sub_admin'))[0]; // Fetch current rider details
                if (!currentSubAdmin) {
        ...
        async getPermissionsPage(req, res) {
            try {
                ...
                return this.errorResponse(res, 'An error occurred while loading permissions.', 500, error);
            }
        }
...
console.log("Sub Admin ID:", req.body.sub_admin_id);
                ...
                console.log(`✅ Deleted old permissions for SubAdmin ID: ${sub_admin_id}`);
                ...
                if (permissions.length > 0) {
                    ...
                    console.log(`✅ Assigned new permissions: ${permissions} for SubAdmin ID: ${sub_admin_id}`);
                }
                ...
                return this.sendSuccess(res, {
                    permissions: assignedPermissions.map((perm) => perm.permission_id),
                }, 'Permissions updated successfully!');
            } catch (error) {
                console.error('❌ Failed to manage permissions:', error);
                return this.sendError(res, 'An error occurred while managing permissions.', 500);
            }
}
